...
$LNG['PM']									= '[PM]';
$LNG['write_message']						= 'Napísať správu';

$LNG['ready']								= 'Ready';

$LNG['loading']								= 'Načítava sa ...';

$LNG['invalid_action']						= 'Neplatná akcia!';

$LNG['type_mission'][1]  					= 'Útok';
$LNG['type_mission'][2]  					= 'ACS - Spoločný útok';
$LNG['type_mission'][3]  					= 'Transport';
$LNG['type_mission'][4]  					= 'Rozmiestniť';
$LNG['type_mission'][5]  					= 'Držať pozíciu';
$LNG['type_mission'][6]  					= 'Špionáž';
$LNG['type_mission'][7]  					= 'Osídliť';
...
$LNG['type_planet'][2]  					= 'Pole trosiek';
$LNG['type_planet'][3]  					= 'Mesiac';
...
$LNG['page_doesnt_exist']					= '404: Táto stránka neexistuje';
...
//----------------------------------------------------------------------------//
// Topnav
$LNG['tn_vacation_mode']					= 'Dovolenkový mód je aktivovaný ';
$LNG['tn_delete_mode']						= 'Váš účet je v móde zmazania. ';

//----------------------------------------------------------------------------//
// Menu
$LNG['lm_overview']							= 'Prehľad';
$LNG['lm_galaxy']							= 'Galaxia';
$LNG['lm_empire']							= 'Impérium';
$LNG['lm_fleet']							= 'Letka';
$LNG['lm_buildings']						= 'Budovy';
$LNG['lm_research']							= 'Výskum';
$LNG['lm_shipshard']						= 'Hangár';
$LNG['lm_defenses']							= 'Obrana';
$LNG['lm_resources']						= 'Suroviny';
$LNG['lm_officiers']						= 'Velitelia';
$LNG['lm_trader']							= 'Obchodník';
$LNG['lm_fleettrader']						= 'Merchant of Fleets';
$LNG['lm_technology']						= 'Technológie';
$LNG['lm_messages']							= 'Správy';
$LNG['lm_alliance']							= 'Alliancia';
$LNG['lm_buddylist']						= 'Priatelia';
$LNG['lm_notes']							= 'Poznámky';
$LNG['lm_statistics']						= 'Štatistiky';
$LNG['lm_search']							= 'Hľadať';
$LNG['lm_options']							= 'Nastavenia';
...
$LNG['lm_rules']							= 'Pravidlá';
$LNG['lm_battlesim']						= 'Simulátor';
$LNG['lm_playercard']                       = 'Profil';
$LNG['lm_info']                     		= 'Info';
...
$LNG['ov_newname_specialchar']				= 'Pre meno planéty sú povolené iba písmená, čísla, medzery, _,-,.';
$LNG['ov_newname_done']						= 'Planéta bola premenovaná!';
$LNG['ov_planet_abandoned']					= 'Planéta bola opustená!';
$LNG['ov_principal_planet_cant_abanone']	= 'Nemôžeš opustiť hlavnú planétu!';
$LNG['ov_abandon_planet_not_possible']		= 'Nemôžeš opustiť planétu na ktorej je aktivita!';
$LNG['ov_wrong_pass']						= 'Nesprávne heslo!';
$LNG['ov_have_new_message']					= 'Máš novú správu';
$LNG['ov_have_new_messages']				= 'Máš %d nových správ';
$LNG['ov_planetmenu']						= 'Premenovať alebo opustiť';
$LNG['ov_free']								= 'Voľno';
$LNG['ov_news']								= 'Novinky';
$LNG['ov_place']							= 'Pozícia';
$LNG['ov_of']								= 'z';
$LNG['ov_planet']							= 'Planéta';
$LNG['ov_server_time']						= 'Serverový čas';
$LNG['ov_events']							= 'Aktivita';
$LNG['ov_diameter']							= 'Priemer';
$LNG['ov_distance_unit']					= 'km';
$LNG['ov_temperature']						= 'Teplota';
$LNG['ov_aprox']							= 'Približne od';
$LNG['ov_temp_unit']						= '°C';
$LNG['ov_to']								= 'do';
$LNG['ov_position']							= 'Pozícia';
$LNG['ov_points']							= 'Body';
$LNG['ov_security_request']					= 'Tajná Otázka';
$LNG['ov_security_confirm']					= 'Prosím potvrď, že chceš opustiť %s .';
$LNG['ov_password']							= 'Heslo';
$LNG['ov_delete_planet']					= 'Opustiť Planétu';
$LNG['ov_planet_rename']					= 'Premenovať Planétu';
$LNG['ov_rename_label']						= 'Nové meno';
$LNG['ov_fields']							= 'Polia';
$LNG['ov_developed_fields']					= 'Využité polia';
$LNG['ov_max_developed_fields']				= 'Max. Permitted fields';
$LNG['ov_fleet']							= 'Letka';
$LNG['ov_admins_online']					= 'Active Admins';
$LNG['ov_no_admins_online']					= 'Žiadny Administrátor nieje pripojený.';
$LNG['ov_userbanner']						= "Hráčov Banner";
$LNG['ov_userrank_info']					= '%s (%s <a href="game.php?page=statistics&amp;range=%d">%d</a> %s %s)';
$LNG['ov_teamspeak_not_online']				= 'Teamspeak server nieje online';
...
$LNG['gl_no_deuterium_to_view_galaxy']		= 'Nemáš dostatok deutéria na prezeranie galaxie';
$LNG['gl_legend']							= 'Legenda';
$LNG['gl_strong_player']					= 'Silný hráč';
$LNG['gl_week_player']						= 'Slabý hráč';
$LNG['gl_vacation']							= 'Dovolenkový mód';
$LNG['gl_banned']							= 'Banned / Suspended';
$LNG['gl_inactive_seven']					= '7 Neaktívnych dní';
$LNG['gl_inactive_twentyeight']				= '28 Neaktívnych dní';
...
$LNG['gl_populed_planets']					= '%d osídlených planét';
$LNG['gl_out_space']						= 'Vonkajší vesmír';
$LNG['gl_avaible_missiles']					= 'Dostupných Rakiet';
$LNG['gl_fleets']							= 'Letky';
/* TODO after rename */
...
/* */
$LNG['gl_missil_launch']					= 'Vystreliť rakety';
$LNG['gl_missil_to_launch']					= 'Počet rakiet (<b>%d</b> disp.):';
$LNG['gl_all_defenses']						= 'Všetká obrana';
$LNG['gl_objective']						= 'Hlavný cieľ';
$LNG['gl_missil_launch_action']				= 'Odoslať';
$LNG['gl_galaxy']							= 'Galaxia';
$LNG['gl_solar_system']						= 'Systém';
$LNG['gl_show']								= 'Zobraziť';
$LNG['gl_pos']								= 'Poz.';
$LNG['gl_planet']							= 'Planéta';
$LNG['gl_name_activity']					= 'Meno (Aktivita)';
$LNG['gl_moon']								= 'Mesiac';
$LNG['gl_debris']							= 'Pole Trosiek';
$LNG['gl_player_estate']					= 'Hráč (Status)';
$LNG['gl_alliance']							= 'Alliancia';
$LNG['gl_actions']							= 'Akcie';
$LNG['gl_spy']								= 'Špionáž';
$LNG['gl_buddy_request']					= 'Žiadosť o priateľstvo';
$LNG['gl_missile_attack']					= 'Raketový útok';
$LNG['gl_with']								= ' with ';
$LNG['gl_member']							= '%d Členov';
$LNG['gl_member_add']						= '%d Člen';
$LNG['gl_alliance_page']					= 'Stránka aliancie';
$LNG['gl_see_on_stats']						= 'Štatistiky';
$LNG['gl_alliance_web_page']				= 'Webová stránka aliancie';
$LNG['gl_debris_field']						= 'Pole Trosiek';
$LNG['gl_collect']							= 'Recyklovať';
$LNG['gl_resources']						= 'Suroviny';
$LNG['gl_features']							= 'Vlastnosti';
$LNG['gl_diameter']							= 'Priemer';
$LNG['gl_temperature']						= 'Teplota';
$LNG['gl_phalanx']							= 'Phalanx';
$LNG['gl_planet_destroyed']					= 'Planéta zničená';
$LNG['gl_playercard']						= 'Hráčov profil';
$LNG['gl_in_the_rank']						= 'Hráč %s na poz. %d';
$LNG['gl_activity']							= '(*)';
$LNG['gl_activity_inactive']				= '(%d min)';
$LNG['gl_ajax_status_ok']					= 'Hotovo';
$LNG['gl_ajax_status_fail']					= 'Chyba';
$LNG['gl_free_desc'] 						= 'Neosídlená planéta. Ideálne miesto pre kolóniu';
$LNG['gl_free'] 							= 'Voľno';
$LNG['gl_yes'] 								= 'Áno';
$LNG['gl_no'] 								= 'Nie';
$LNG['gl_points'] 							= 'Body';
...
//----------------------------------------------------------------------------//
// Sensor Phalanx
$LNG['px_no_deuterium']						= "Nemáš dostatok deutéria!";
$LNG['px_scan_position']					= 'Preskúmať pozíciu';
$LNG['px_fleet_movement']					= 'Letka v pohybe';
$LNG['px_no_fleet']							= 'Žiadne letky v pohybe.';
$LNG['px_out_of_range']						= 'Mimo dosah';

//----------------------------------------------------------------------------//
// Império
$LNG['lv_imperium_title']					= 'Impérium';
$LNG['lv_planet']							= 'Planéta';
$LNG['lv_name']								= 'Meno';
$LNG['lv_coords']							= 'Súradnice';
$LNG['lv_fields']							= 'Polia';
$LNG['lv_resources']						= 'Suroviny';
$LNG['lv_buildings']						= 'Stavby';
$LNG['lv_technology']						= 'Technológie';
$LNG['lv_ships']							= 'Lode';
$LNG['lv_defenses']							= 'Obrana';
$LNG['lv_total']							= 'Spolu';
...
$LNG['fl_r']								= '(R)';
$LNG['fl_a']								= '(A)';
$LNG['fl_send_back']						= 'Stiahnuť';
$LNG['fl_acs']								= 'ACS';
$LNG['fl_no_more_slots']					= 'Žiadne voľné miesto';
$LNG['fl_speed_title']						= 'Rýchlosť: ';
$LNG['fl_continue']							= 'Pokračovať';
$LNG['fl_no_ships']							= 'Žiadne lode dostupné';
$LNG['fl_remove_all_ships']					= 'Žiadne lode';
$LNG['fl_select_all_ships']					= 'Všetky lode';
$LNG['fl_fleets']							= 'Letka';
$LNG['fl_expeditions']						= 'expedícia';
$LNG['fl_number']							= 'ID';
$LNG['fl_mission']							= 'Misia';
$LNG['fl_ammount']							= 'Počet';
$LNG['fl_beginning']						= 'Štart';
$LNG['fl_departure']						= 'Prílet(Cieľ)';
$LNG['fl_destiny']							= 'Cieľ';
$LNG['fl_objective']						= 'Objective';
$LNG['fl_arrival']							= 'Prílet(Späť)';
$LNG['fl_info_detail']						= 'Detaily';
$LNG['fl_order']							= 'Akcie';
$LNG['fl_new_mission_title']				= 'Nová misia: Vyber letku';
$LNG['fl_ship_type']						= 'Typ lode';
$LNG['fl_ship_available']					= 'Dostupné lode';
$LNG['fl_planet_shortcut']					= '(P)';
$LNG['fl_debris_shortcut']					= '(DF)';
$LNG['fl_moon_shortcut']					= '(M)';
$LNG['fl_no_shortcuts']						= 'Žiadne skratky';
$LNG['fl_register_shorcut']					= 'Vytvoriť';
$LNG['fl_shortcuts']						= 'Skratky';
$LNG['fl_dlte_shortcut']					= 'Vymazať';
$LNG['fl_shortcut_add']						= 'Pridať';
$LNG['fl_shortcut_edition']					= 'Upraviť skratku';
$LNG['fl_shortcut_save']					= 'Uložiť skratku';
$LNG['fl_shortcut_saved']					= 'Skratka uložená!';
$LNG['fl_no_colony']						= 'Žiadne kolónie';
$LNG['fl_send_fleet']						= 'Poslať letku';
$LNG['fl_fleet_speed']						= 'Rýchlosť';
$LNG['fl_distance']							= 'Vzdialenosť';
$LNG['fl_shortcut_name']					= 'Meno';
$LNG['fl_flying_time']					    = 'Doba letu';
$LNG['fl_flying_arrival']					= 'Prílet';
$LNG['fl_flying_return']					= 'Návrat';
$LNG['fl_fuel_consumption']			        = 'Spotreba Deutéria';
$LNG['fl_max_speed']						= 'Max Rýchlosť';
$LNG['fl_cargo_capacity']				    = 'Nákladový priestor';
$LNG['fl_shortcut']							= 'Skratky';
$LNG['fl_my_planets']					    = 'Moje planéty';
$LNG['fl_acs_title']						= 'Aliančný útok';
$LNG['fl_hold_time']						= 'At Flying';
$LNG['fl_resources']						= 'Suroviny';
$LNG['fl_max']								= 'max';
$LNG['fl_hours']                            = 'Hodiny';
$LNG['fl_resources_left']				    = 'Zostávajúce miesto';
$LNG['fl_all_resources']			        = 'Všetky suroviny';
$LNG['fl_multi_alarm']						= 'Multi alarm!';
$LNG['fl_admins_cannot_be_attacked']		= 'Nemôžeš zaútočiť na Administrátorov';
$LNG['fl_empty_target']						= 'Cieľ neexistuje';
$LNG['fl_expedition_alert_message']		    = 'Výstraha! Expedície sú nebezpečné a môžeš prísť o svoje lode!';
$LNG['fl_dm_alert_message']                 = 'Beware, if in %s %s was found, destroyed the fleets!';
$LNG['fl_vacation_mode_active']			    = 'Dovolenkový mód';
$LNG['fl_expedition_fleets_limit']		    = 'Žiadne miesto pre expedíciu!';
$LNG['fl_week_player']						= 'Hráč je pod začiatočníckou ochranou';
$LNG['fl_strong_player']					= 'Hráč je príliš silný';
$LNG['fl_in_vacation_player']				= 'Hráč je v dovolenkovom móde';
$LNG['fl_no_slots']							= 'Žiadne miesto dostupné';
$LNG['fl_planet_populed']					= 'Táto planéta je kolonizovaná';
$LNG['fl_no_same_alliance']				    = 'Vlastník planéty musí byť člen tvojej aliancie alebo tvoj priateľ!';
$LNG['fl_not_ally_deposit']				    = 'Žiadne Aliančné centrum';
$LNG['fl_deploy_only_your_planets']			= 'Rozmiestniť letky možeš iba na vlastné planéty!';
$LNG['fl_fleet_sended']						= 'Letka odoslaná';
$LNG['fl_from']								= 'Z';
$LNG['fl_arrival_time']						= 'Prílet';
$LNG['fl_return_time']						= 'Návrat';
$LNG['fl_fleet']							= 'Letka';
$LNG['fl_player']							= 'Hráč ';
$LNG['fl_add_to_attack']					= ' pridaný do útoku.';
$LNG['fl_already_invited']					= ' bol pozvaný..';
$LNG['fl_dont_exist']						= ' neexistuje.';
$LNG['fl_acs_invitation_message']			= ' pozvaný do ACS.';
$LNG['fl_acs_invitation_title']				= 'ACS';
$LNG['fl_sac_of_fleet']						= 'ACS letka';
$LNG['fl_modify_sac_name']					= 'ACS meno';
$LNG['fl_members_invited']					= 'Hostia';
$LNG['fl_invite_members']					= 'Pozvať členov';
$LNG['fl_simulate']							= 'Simulátor';
$LNG['fl_bonus']							= 'Bonus';
$LNG['fl_bonus_attack']						= 'Zbrane';
$LNG['fl_bonus_defensive']					= 'Pancierovanie';
$LNG['fl_bonus_shield']						= 'Štít';
$LNG['fl_no_empty_derbis']					= 'Žiadne pole trosiek!';
$LNG['fl_acs_newname_alphanum']				= 'Meno ACS môže obsahovať iba alfanumerické znaky';
$LNG['fl_acs_change']						= 'Zmeniť';
$LNG['fl_acs_change_name']					= 'Nové meno';
$LNG['fl_error_not_avalible']				= 'Na týchto súradniciach neexistuje žiadna planéta';
$LNG['fl_error_empty_derbis']				= "Žiadne pole trosiek";
$LNG['fl_error_no_moon']					= 'Na týchto súradniciach neexistuje žiadny mesiac';
$LNG['fl_send_error'][3]					= 'Odlet a cieľ je tá istá planéta';
$LNG['fl_send_error'][4]					= 'Neplatný cieľ';
$LNG['fl_send_error'][5]					= 'Bez surovín na transport';
$LNG['fl_send_error'][6]					= 'Žiadne voľné miesto pre letky!';
$LNG['fl_send_error'][7]					= 'Cieľová planéta neexistuje';
$LNG['fl_send_error'][8]					= 'The ships are not all present';
$LNG['fl_send_error'][9]					= 'Žiadne voľné miesto pre expedície';
$LNG['fl_send_error'][10]					= "Nedostatočná úroveň Astrofyziky.";
$LNG['fl_send_error'][12]					= 'Hráč je v dovolenkovom móde';
$LNG['fl_send_error'][13]					= 'Ochrana pred búšením.';
$LNG['fl_send_error'][14]					= 'Nemôžeš zaútočiť na Administrátorov';
$LNG['fl_send_error'][15]					= 'Hráč je pod začiatočníckou ochranou';
$LNG['fl_send_error'][16]					= 'Hráč je príliš silný';
$LNG['fl_send_error'][17]					= 'Na cieľovej planéte nieje Aliančné centrum';
$LNG['fl_send_error'][18]					= 'Tento hráč je v tvojej aliancii alebo je tvoj priateľ!';
$LNG['fl_send_error'][19]					= "Nemáš dostatok deutéria. Máš %s. Je potrebné %s %s!";
$LNG['fl_send_error'][20]					= 'Málo kapacity. Dostupné:';
$LNG['fl_send_error'][21]					= 'Pole trosiek neexistuje!';
$LNG['fl_send_error'][22]					= 'Nieje nastavená misia.';

//----------------------------------------------------------------------------//
// Edificios
$LNG['bd_dismantle']						= 'Zbúrať';
$LNG['bd_interrupt']						= 'Zrušiť';
$LNG['bd_cancel']							= 'Zrušiť';
$LNG['bd_working']							= 'Pracuje';
$LNG['bd_build']							= 'Postaviť';
$LNG['bd_build_next_level']					= 'Vylepšiť';
$LNG['bd_research']							= 'Vyskúmať';
$LNG['bd_tech']								= 'Výskum';
$LNG['bd_tech_next_level']					= 'Vyskúmať na dalšiu úroveň ';
$LNG['bd_add_to_list']				        = 'Pridať';
$LNG['bd_no_more_fields']					= 'Na planéte nieje voľné miesto';
$LNG['bd_remaining']						= 'Zostáva:';
$LNG['bd_lab_required']					    = 'Vyžaduje sa Výskumné laboratórium!';
$LNG['bd_building_lab']					    = 'Nemôžeš skúmať keď sa vylepšuje laboratórium.';
$LNG['bd_max_lvl']                          = 'Max. úroveň:';
$LNG['bd_lvl']								= 'Úroveň';
...
$LNG['bd_actual_production']				= 'Aktívna Produkcia:';
$LNG['bd_completed']						= 'Hovotový';
$LNG['bd_operating']						= '(Vo výstavbe)';
$LNG['bd_continue']							= 'Pokračovať';
$LNG['bd_price_for_destroy']				= 'Cena na zbúranie:';
$LNG['bd_ready']							= 'Pripravený';
$LNG['bd_finished']							= 'Hotový';
$LNG['bd_maxlevel']                         = 'Maximálna úroveň';
$LNG['bd_on']                               = 'pripojený';
$LNG['bd_max_builds']                       = 'You will have only max. %d queue building!';
$LNG['bd_next_level']                       = 'Ďalšia úroveň:';
$LNG['bd_need_engine']                      = 'Need more <font color="#FF0000">%s</font> of %s';
$LNG['bd_more_engine']                      = 'Produced <font color="#00FF00">%s</font> %s more';
$LNG['bd_jump_gate_action']                 = 'Skok';
$LNG['bd_cancel_warning']                   = 'VAROVANIE! <br> Vráti sa iba 60% surovín.';
$LNG['bd_cancel_send']                      = 'Zrušiť stavbu';
$LNG['bd_destroy_time'] 					= 'Trvanie';
$LNG['bd_max_ships']                                            = 'max';
$LNG['bd_max_ships_long']                                       = 'Maximum possible units to build';
$LNG['sys_notenough_money'] 				= 'Nemáš dostatok surovín na %s <a href="./game.php?page=buildings&amp;cp=%d&amp;re=0">[%d:%d:%d]</a> pre stavbu. <br>Tvoje suroviny %s %s , %s %s a %s %s. <br>Cena stavby %s %s , %s %s a %s %s.';
...
//----------------------------------------------------------------------------//
// Recursos
$LNG['rs_amount']							= 'Množstvo';
$LNG['rs_lvl']								= 'Úroveň';
$LNG['rs_production_on_planet']			    = 'Suroviny na planéte "%s"';
$LNG['rs_basic_income']					    = 'Základ';
$LNG['rs_storage_capacity']				    = 'Veľkosť skladov';
$LNG['rs_calculate']						= 'Vypočítať';
$LNG['rs_sum']								= 'Spolu';
$LNG['rs_daily']					        = 'Denná produkcia:';
$LNG['rs_weekly']							= 'Týždenná produkcia:';
$LNG['rs_ress_bonus']                       = 'Bonus (Velitelia/Bonus):';
